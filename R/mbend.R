...
#' Another method implemented in this package is from Schaeffer (2014), which can be defined by using the argument \code{method = "lrs"}. If no method is defined, the default \code{method = "hj"} (Jorjani et al., 2003) is used. As a development to the method of Schaeffer (2014), a weight matrix can be used for weighted bending.
