...
As it can be seen in the report, 3 of the 15 upper triangle elements are set to constant.
...
As indicated above, diagonal elements are not used in the reporting statistics. This happens to correlation matrices.
